<template>
  ...
  <circle cx="12" cy="12" r="10.5" fill="url(#paint0_linear_1001_1909)"/>
  ...
  <defs>
  <linearGradient id="paint0_linear_1001_1909" x1="12" y1="1.5" x2="12" y2="22.5" gradientUnits="userSpaceOnUse">
